...
{
	checkf(!CharacterCarriedWeaponMap.Contains(InWeaponTagToRegister), TEXT("A named naed %s has already added as carried weapon"), *InWeaponTagToRegister.ToString());
